...
function updateBuyButton(el) {
    ...
    el.closest('form').querySelector('input[type=\'submit\']').setAttribute('data-description',el.options[el.selectedIndex].getAttribute('data-description')); /*added by me*/
...
function addToCart(el) {
    ...
    if(!found) {
        var newitem = {
            ...
            description: el.querySelector('input[type=\'submit\']').getAttribute('data-description'), /*added by me*/
            quantity: 1
        };
        cart.push(newitem);
    }
    ...
    for (i=0; i<inputs.length; i++){
        if(inputs[i].getAttribute('data-price') && inputs[i].checked) {
            var newitem = {
                ...
                description: inputs[i].getAttribute('data-description') /*added by me*/
            }
            addons.push(newitem);
        }
